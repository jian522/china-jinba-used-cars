...
for page in root.rglob('*.html'):
    ...
    else: text=re.sub(r'/assets/jinba-global\.css(?:\?v=[^"\']*)?', '/assets/jinba-global.css?v=20260712g4', text)
    if 'jinba-global.js' not in text: text=text.replace('</body>','  <script src="/assets/jinba-global.js?v=20260712g2" defer></script>\n</body>')
    else: text=re.sub(r'/assets/jinba-global\.js(?:\?v=[^"\']*)?', '/assets/jinba-global.js?v=20260712g4', text)
